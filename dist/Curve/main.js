...
/* harmony import */ var _services_dataset_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/dataset.service */ "./src/app/services/dataset.service.ts");
/* harmony import */ var src_app_services_options_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/options.service */ "./src/app/services/options.service.ts");
...
/* harmony import */ var src_app_services_views_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/views.service */ "./src/app/services/views.service.ts");
...
var ControlComponent = /** @class */ (function () {
    ...
    ControlComponent.prototype.ngOnInit = function () {
        ...
        document.addEventListener('keydown', function (event) {
            ...
            var binding = lodash__WEBPACK_IMPORTED_MODULE_1__["find"](_this.keyBindings, function (kbd) { return kbd.key === event.key && kbd.ctrl === event.ctrlKey; });
            if (binding) {
                binding.action();
            }
        });
    ...
    ControlComponent.prototype.createNewUnit = function (unit) {
        // create unit
    ...
    ControlComponent.prototype.deleteDataset = function (dataset) {
        ...
        this.dsProvider.deleteDataset(dataset.id)
            .then(function (id) {
            lodash__WEBPACK_IMPORTED_MODULE_1__["remove"](_this.datasets, function (ds) { return ds.id === id; });
        })
            .catch(console.log);
    };
    ...
    ControlComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_dataset_service__WEBPACK_IMPORTED_MODULE_2__["DatasetService"],
            src_app_services_options_service__WEBPACK_IMPORTED_MODULE_3__["OptionsService"],
            _services_units_service__WEBPACK_IMPORTED_MODULE_4__["UnitsService"],
            src_app_services_views_service__WEBPACK_IMPORTED_MODULE_5__["ViewsService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_painter_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/painter.service */ "./src/app/services/painter.service.ts");
/* harmony import */ var _services_units_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/units.service */ "./src/app/services/units.service.ts");
...
var DisplayComponent = /** @class */ (function () {
    ...
    DisplayComponent.prototype.ngOnInit = function () {
        ...
        document.addEventListener('keyup', function (event) {
            ...
            if (!(document.activeElement instanceof HTMLInputElement)) {
                var binding = lodash__WEBPACK_IMPORTED_MODULE_3__["find"](_this.keyBindings, function (kbd) { return kbd.key == event.key && kbd.ctrl == event.ctrlKey; });
                if (binding) {
                    binding.action();
                }
            }
    ...
    DisplayComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_painter_service__WEBPACK_IMPORTED_MODULE_1__["PainterService"],
            _services_units_service__WEBPACK_IMPORTED_MODULE_2__["UnitsService"]])
    ], DisplayComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_views_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/views.service */ "./src/app/services/views.service.ts");
...
/* harmony import */ var _services_dataset_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/dataset.service */ "./src/app/services/dataset.service.ts");
...
var SideMenuComponent = /** @class */ (function () {
    function SideMenuComponent(viewsProvider, dialogsctrl, optionsProvider, dsProvider, projectsProvider, dialogsCtrl) {
        ...
        this.newProject = { title: '', createdIn: '' };
    }
    ...
    SideMenuComponent.prototype.editView = function (view) {
        ...
        this.viewsProvider.EditView(view)
            .then(function (newView) {
            var i = lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](_this.views, { id: newView.id });
    ...
    SideMenuComponent.prototype.deleteView = function (id) {
        ...
        this.viewsProvider.deleteView(id)
            .then(function () {
            lodash__WEBPACK_IMPORTED_MODULE_5__["remove"](_this.views, function (view) { return view.id === id; });
            if (_this.views[0]) {
                _this.setActiveView(_this.views[0]);
            }
            else {
    ...
    SideMenuComponent.prototype.deleteProject = function (id) {
        ...
        this.projectsProvider.deleteProject(id)
            .then(function () {
            lodash__WEBPACK_IMPORTED_MODULE_5__["remove"](_this.projects, function (project) { return project.id === id; });
            if (_this.projects[0]) {
                _this.setActiveProject(_this.projects[0]);
            }
            else {
    ...
    SideMenuComponent.prototype.editProject = function (project) {
        ...
        this.projectsProvider.EditProject(project)
            ...
            var i = lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](_this.projects, { id: project.id });
    ...
    SideMenuComponent.prototype.createProjectFromFileData = function (i_project) {
        ...
        return new Promise(function (res, rej) {
            _this.projectsProvider.createProject(i_project)
                ...
                var views$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["from"])(i_project.views);
    ...
    SideMenuComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_views_service__WEBPACK_IMPORTED_MODULE_1__["ViewsService"],
            _services_dialogs_service__WEBPACK_IMPORTED_MODULE_6__["DialogsService"],
            _services_options_service__WEBPACK_IMPORTED_MODULE_2__["OptionsService"],
            _services_dataset_service__WEBPACK_IMPORTED_MODULE_3__["DatasetService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_dataset_parser_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/dataset-parser.service */ "./src/app/services/dataset-parser.service.ts");
/* harmony import */ var _services_units_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/units.service */ "./src/app/services/units.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var WorkspaceComponent = /** @class */ (function () {
    ...
    WorkspaceComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_dataset_parser_service__WEBPACK_IMPORTED_MODULE_1__["DatasetParserService"],
            _services_units_service__WEBPACK_IMPORTED_MODULE_2__["UnitsService"]])
    ], WorkspaceComponent);
